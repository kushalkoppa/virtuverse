# PlantHub Installation Guide

## Prerequisites

Before installing PlantHub, ensure you have:
...
### 2. Navigate to PlantHub Directory
...
Create a `.env` file in the PlantHub directory:
...
You should see the PlantHub dashboard.
...
# Get sharing records
curl http://localhost:3002/api/sharing
```
...
1. Read the [User Guide](docs/USER_GUIDE.md) to learn how to use PlantHub
